...
def upgrade():
    ...
    op.add_column('train_containers', sa.Column('model_filepath', sa.String(), nullable=True))
    op.add_column('train_containers', sa.Column('score_regexp', sa.String(), nullable=True))
