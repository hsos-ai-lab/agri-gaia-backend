...
def upgrade():
    ...
    op.execute('ALTER TABLE container_images RENAME CONSTRAINT containers_model_id_fkey TO container_images_model_id_fkey')

    op.execute('ALTER TABLE container_deployments RENAME COLUMN container_id TO container_image_id')
    op.execute('ALTER TABLE container_deployments RENAME CONSTRAINT container_deployments_container_id_fkey TO container_images_deployments_container_id_fkey')
...
def downgrade():
    ...
    op.execute('ALTER TABLE container_deployments RENAME CONSTRAINT container_images_deployments_container_id_fkey TO container_deployments_container_id_fkey')
    op.execute('ALTER TABLE container_deployments RENAME COLUMN container_image_id TO container_id')

    op.execute('ALTER TABLE container_images RENAME CONSTRAINT container_images_model_id_fkey TO containers_model_id_fkey')
