...
def register_testuser(test_user: Testuser):
    ...
    response = requests.post(USERS_ENDPOINT, headers=headers, data=payload)
...
def test_container_deployment(
    ...
    data = {
        ...
        "edge_device_id": f"{registered_test_edge_device.id}",
...
def test_application(
    ...
    assert response.status_code == HTTP_201_CREATED, "Could not create edge group"
